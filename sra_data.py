"""
Statutory text of The Specific Relief Act, 1963 (Act No. 47 of 1963).
Incorporating all amendments up to Act 18 of 2018 (w.e.f. 01-10-2018).
"""
...
SRA_SECTIONS: List[SRASection] = [
    ...
    SRASection(
        ...
        chapter="PRELIMINARY",
        text="""1. Short title, extent and commencement.—(1) This Act may be called the Specific Relief Act, 1963.
...
(e) all other words and expressions used herein but not defined, and defined in the Indian Contract Act, 1872 (9 of 1872), have the meanings respectively assigned to them in that Act."""
    ...
    SRASection(
        ...
        part="PART I — PRELIMINARY",
        chapter="PRELIMINARY",
        text="""3. Savings.—Except as otherwise provided herein, nothing in this Act shall be deemed—
...
(b) to affect the operation of the Indian Registration Act, 1908 (16 of 1908), on documents."""
    ...
    SRASection(
        ...
        part="PART I — PRELIMINARY",
        chapter="PRELIMINARY",
        text="""4. Specific relief to be granted only for enforcing individual civil rights and not for enforcing penal laws.—Specific relief can be granted only for the purpose of enforcing individual civil rights and not for the mere purpose of enforcing a penal law."""
    ),
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER I — RECOVERING POSSESSION OF PROPERTY",
        text="""5. Recovery of specific immovable property.—A person entitled to the possession of specific immovable property may recover it in the manner provided by the Code of Civil Procedure, 1908 (5 of 1908)."""
    ),
    SRASection(
        section_no="6",
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER I — RECOVERING POSSESSION OF PROPERTY",
        text="""6. Suit by person dispossessed of immovable property.—(1) If any person is dispossessed without his consent of immovable property otherwise than in due course of law, he or any person through whom he has been in possession or any person claiming through him may, by suit, recover possession thereof, notwithstanding any other title that may be set up in such suit.
...
(4) Nothing in this section shall bar any person from suing to establish his title to such property and to recover possession thereof."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER I — RECOVERING POSSESSION OF PROPERTY",
        text="""7. Recovery of specific movable property.—A person entitled to the possession of specific movable property may recover it in the manner provided by the Code of Civil Procedure, 1908 (5 of 1908).
...
(b) that it would be extremely difficult to ascertain the actual damage caused by its loss."""
    ...
    SRASection(
        ...
        text="""9. Defences respecting suits for relief based on contract.—Except as otherwise provided herein where any relief is claimed under this Chapter in respect of a contract, the person against whom the relief is claimed may plead by way of defence any ground which is available to him under any law relating to contracts."""
    ),
    SRASection(
        section_no="10",
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""10. Specific performance in respect of contracts.—The specific performance of a contract shall be enforced by the court subject to the provisions contained in sub-section (2) of section 11, section 14 and section 16.

[Note: Substituted by the Specific Relief (Amendment) Act, 2018 (Act 18 of 2018), s. 3 (w.e.f. 1-10-2018). Specific performance is now a mandatory statutory remedy rather than a discretionary relief.]"""
    ),
    SRASection(
        section_no="11",
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""11. Cases in which specific performance of contracts connected with trusts enforceable.—(1) Except as otherwise provided in this Act, specific performance of a contract shall be enforced when the act agreed to be done is in the performance wholly or partly of a trust.
(2) A contract made by a trustee in excess of his powers or in breach of trust cannot be specifically enforced."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""12. Specific performance of part of contract.—(1) Except as otherwise hereinafter provided in this section, the court shall not direct the specific performance of a part of a contract.
...
(2) The provisions of sub-section (1) shall also apply, as far as may be, to contracts for the sale or hire of movable property."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""14. Contracts not specifically enforceable.—The following contracts cannot be specifically enforced, namely:—
...
[Note: Substituted by the Specific Relief (Amendment) Act, 2018 (Act 18 of 2018), s. 5 (w.e.f. 1-10-2018). Determinable contracts, contracts requiring continuous court supervision, contracts involving personal qualifications, and contracts where substituted performance was availed cannot be specifically enforced.]"""
    ),
    SRASection(
        section_no="14A",
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""14A. Power of court to engage experts.—(1) Without prejudice to the generality of the provisions contained in the Code of Civil Procedure, 1908 (5 of 1908), in any suit under this Act, where the court considers it necessary to get expert opinion to assist it on any specific issue involved in the suit, it may engage one or more experts and direct to report to it on such issue and may secure attendance of the expert for providing evidence, including production of documents on the issue.
...
[Note: Inserted by the Specific Relief (Amendment) Act, 2018 (Act 18 of 2018), s. 5 (w.e.f. 1-10-2018). Enables courts to appoint independent scientific, financial, or valuation experts.]"""
    ),
    SRASection(
        section_no="15",
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""15. Who may obtain specific performance.—Except as otherwise provided by this Chapter, the specific performance of a contract may be obtained by—
(a) any party thereto;
...
Provided that the company has accepted the contract and has communicated such acceptance to the other party to the contract."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""16. Personal bars to relief.—Specific performance of a contract cannot be enforced in favour of a person—
...
[Note: Clause (a) substituted and clause (c) amended by Act 18 of 2018 (w.e.f. 1-10-2018). The requirement of "aver and prove" was amended to "who fails to prove". Actual deposit of money in court is not mandatory unless expressly ordered by the court.]"""
    ),
    SRASection(
        section_no="17",
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""17. Contract to sell or let property by one who has no title, not specifically enforceable.—(1) A contract to sell or let any immovable property cannot be specifically enforced in favour of a vendor or lessor—
...
(2) The provisions of sub-section (1) shall also apply, as far as may be, to contracts for the sale or hire of movable property."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""18. Non-enforcement except with variation.—Where a plaintiff seeks specific performance of a contract in writing, to which the defendant sets up a variation, the plaintiff cannot obtain the performance sought, except with the variation so set up, in the following cases, namely:—
...
(c) where the parties have, subsequently to the execution of the contract, varied its terms."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""19. Relief against parties and persons claiming under them by subsequent title.—Except as otherwise provided by this Chapter, specific performance of a contract may be enforced against—
...
[Note: Substituted by the Specific Relief (Amendment) Act, 2018 (Act 18 of 2018), s. 10 (w.e.f. 1-10-2018). Introduces substituted performance as an alternative remedy, requiring 30 days mandatory notice before getting performance done through a third party or own agency.]"""
    ),
    SRASection(
        section_no="20A",
...
[Note: Inserted by Act 18 of 2018, s. 10 (w.e.f. 1-10-2018). Imposes an absolute statutory bar against granting injunctions that impede or delay infrastructure projects listed in The Schedule.]"""
    ),
    SRASection(
        section_no="20B",
...
[Note: Inserted by Act 18 of 2018, s. 10 (w.e.f. 1-10-2018). Designates dedicated civil courts for expeditious resolution of infrastructure disputes.]"""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""20C. Expeditious disposal of suits.—Notwithstanding anything contained in the Code of Civil Procedure, 1908 (5 of 1908), a suit filed under the provisions of this Act shall be disposed of by the court within a period of twelve months from the date of service of summons to the defendant:
...
[Note: Inserted by Act 18 of 2018, s. 10 (w.e.f. 1-10-2018). Statutory mandate for civil courts to dispose of Specific Relief suits within 12 months (outer limit 18 months).]"""
    ),
    SRASection(
        section_no="21",
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""21. Power to award compensation in certain cases.—(1) In a suit for specific performance of a contract, the plaintiff may also claim compensation for its breach in addition to such performance.
...
(2) When enforcing specific performance under this section, the court shall not also decree payment of the sum so named in the contract."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER II — SPECIFIC PERFORMANCE OF CONTRACTS",
        text="""25. Application of preceding sections to certain awards and testamentary directions to execute settlements.—The provisions of this Chapter as to contracts shall apply to awards to which the Arbitration and Conciliation Act, 1996 (26 of 1996), does not apply and to directions in a will or codicil to execute a particular settlement."""
    ),
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER III — RECTIFICATION OF INSTRUMENTS",
        text="""26. When instrument may be rectified.—(1) When, through fraud or a mutual mistake of the parties, a contract or other instrument in writing [not being the articles of association of a company to which the Companies Act, 1956 (1 of 1956), applies] does not express their real intention, then—
...
Provided that where a party has not claimed any such relief in his pleading, the court shall, at any stage of the proceeding, allow him to amend the pleading on such terms as may be just for including such claim."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER IV — RESCISSION OF CONTRACTS",
        text="""27. When rescission may be adjudged or refused.—(1) Any person interested in a contract may sue to have it rescinded, and such rescission may be adjudged by the court in any of the following cases, namely:—
...
Explanation.—In this section “contract” in relation to the territories to which the Transfer of Property Act, 1882 (4 of 1882), does not extend, means a contract in writing."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER IV — RESCISSION OF CONTRACTS",
        text="""28. Rescission in certain circumstances of contracts for the sale or lease of immovable property, the specific performance of which has been decreed.—(1) Where in any suit a decree for specific performance of a contract for the sale or lease of immovable property has been made and the purchaser or lessee does not, within the period allowed by the decree or such further period as the court may allow, pay the purchase money or other sum which the court has ordered him to pay, the vendor or lessor may apply in the same suit in which the decree is made, to have the contract rescinded and on such application the court may, by order, rescind the contract either so far as regards the party in default or altogether, as the justice of the case may require.
...
(5) The costs of any proceedings under this section shall be in the discretion of the court."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER IV — RESCISSION OF CONTRACTS",
        text="""29. Alternative prayer for rescission in suit for specific performance.—A plaintiff instituting a suit for the specific performance of a contract in writing may pray in the alternative that, if the contract cannot be specifically enforced, it may be rescinded and delivered up to be cancelled; and the court, if it refuses to enforce the contract specifically, may direct it to be rescinded and delivered up accordingly."""
    ),
    SRASection(
        section_no="30",
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER V — CANCELLATION OF INSTRUMENTS",
        text="""31. When cancellation may be ordered.—(1) Any person against whom a written instrument is void or voidable, and who has reasonable apprehension that such instrument, if left outstanding may cause him serious injury, may sue to have it adjudged void or voidable; and the court may, in its discretion, so adjudge it and order it to be delivered up and cancelled.
(2) If the instrument has been registered under the Indian Registration Act, 1908 (16 of 1908), the court shall also send a copy of its decree to the officer in whose office the instrument has been so registered; and such officer shall note on the copy of the instrument contained in his books the fact of its cancellation."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER V — CANCELLATION OF INSTRUMENTS",
        text="""32. What instruments may be partially cancelled.—Where an instrument is evidence of different rights or different obligations, the court may, in a proper case, cancel it in part and allow it to stand for the residue."""
    ),
    SRASection(
        section_no="33",
...
(b) that the agreement sought to be enforced against him in the suit is void by reason of his not having been competent to contract under section 11 of the Indian Contract Act, 1872 (9 of 1872), the court may, if the defendant has received any benefit under the agreement from the other party, require him to restore, so far as may be, such benefit to that party, to the extent to which he or his estate has benefited thereby."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER VI — DECLARATORY DECREES",
        text="""34. Discretion of court as to declaration of status or right.—Any person entitled to any legal character, or to any right as to any property, may institute a suit against any person denying, or interested to deny, his title to such character or right, and the court may in its discretion make therein a declaration that he is so entitled, and the plaintiff need not in such suit ask for any further relief:
...
Explanation.—A trustee of property is a “person interested to deny” a title adverse to the title of some one who is not inexistence, and for whom, if in existence, he would be a trustee."""
    ...
    SRASection(
        ...
        part="PART II — SPECIFIC RELIEF",
        chapter="CHAPTER VI — DECLARATORY DECREES",
        text="""35. Effect of declaration.—A declaration made under this Chapter is binding only on the parties to the suit, persons claiming through them respectively, and, where any of the parties are trustees, on the persons for whom, if in existence at the date of the declaration, such parties would be trustees."""
    ),
    ...
    SRASection(
        ...
        part="PART III — PREVENTIVE RELIEF",
        chapter="CHAPTER VII — INJUNCTIONS GENERALLY",
        text="""36. Preventive relief how granted.—Preventive relief is granted at the discretion of the court by injunction, temporary or perpetual."""
    ),
    SRASection(
        section_no="37",
        ...
        part="PART III — PREVENTIVE RELIEF",
        chapter="CHAPTER VII — INJUNCTIONS GENERALLY",
        text="""37. Temporary and perpetual injunctions.—(1) Temporary injunctions are such as are to continue until a specific time, or until the further order of the court, and they may be granted at any stage of a suit, and are regulated by the Code of Civil Procedure, 1908 (5 of 1908).
(2) A perpetual injunction can only be granted by the decree made at the hearing and upon the merits of the suit; the defendant is thereby perpetually enjoined from the assertion of a right, or from the commission of an act, which would be contrary to the rights of the plaintiff."""
    ...
    SRASection(
        ...
        part="PART III — PREVENTIVE RELIEF",
        chapter="CHAPTER VIII — PERPETUAL INJUNCTIONS",
        text="""38. Perpetual injunction when granted.—(1) Subject to the other provisions contained in or referred to by this Chapter, a perpetual injunction may be granted to the plaintiff to prevent the breach of an obligation existing in his favour, whether expressly or by implication.
...
(d) where the injunction is necessary to prevent a multiplicity of judicial proceedings."""
    ...
    SRASection(
        ...
        part="PART III — PREVENTIVE RELIEF",
        chapter="CHAPTER VIII — PERPETUAL INJUNCTIONS",
        text="""40. Damages in lieu of, or in addition to, injunction.—(1) The plaintiff in a suit for perpetual injunction under section 38, or mandatory injunction under section 39, may claim damages either in addition to, or in substitution for, such injunction and the court may, if it thinks fit, award such damages.
...
(3) The dismissal of a suit to prevent the breach of an obligation existing in favour of the plaintiff shall bar his right to sue for damages for such breach."""
    ...
    SRASection(
        ...
        part="PART III — PREVENTIVE RELIEF",
        chapter="CHAPTER VIII — PERPETUAL INJUNCTIONS",
        text="""41. Injunction when refused.—An injunction cannot be granted—
...
[Note: Clause (ha) inserted by the Specific Relief (Amendment) Act, 2018 (Act 18 of 2018), s. 13 (w.e.f. 1-10-2018), prohibiting injunctions in infrastructure projects.]"""
    ),
    SRASection(
        section_no="42",
        ...
        part="PART III — PREVENTIVE RELIEF",
        chapter="CHAPTER VIII — PERPETUAL INJUNCTIONS",
        text="""42. Injunction to perform negative agreement.—Notwithstanding anything contained in clause (e) of section 41, where a contract comprises an affirmative agreement to do a certain act, coupled with a negative agreement, express or implied, not to do a certain act, the circumstance that the court is unable to compel specific performance of the affirmative agreement shall not preclude it from granting an injunction to perform the negative agreement:
Provided that the plaintiff has not failed to perform the contract so far as it is binding on him."""
    ),

    # -------------------------------------------------------------------------
    # THE SCHEDULE — INFRASTRUCTURE PROJECTS (SECTIONS 20A AND 41(ha))
    # -------------------------------------------------------------------------
    SRASection(
        section_no="Schedule",
        title="Category of Projects and Infrastructure Sub-Sectors [Sections 20A and 41(ha)]",
        part="THE SCHEDULE",
...
[Note: The Schedule inserted by the Specific Relief (Amendment) Act, 2018 (Act 18 of 2018), s. 14 (w.e.f. 1-10-2018). Governs statutory bar on injunctions under Sections 20A & 41(ha).]"""
    )
]
